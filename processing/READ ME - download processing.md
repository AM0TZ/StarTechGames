download the latest version of processing JRE (that doesnt require instaltion) from:[here](https://github.com/processing/processing4/releases/download/processing-1297-4.3.4/processing-4.3.4-windows-x64.zip):
